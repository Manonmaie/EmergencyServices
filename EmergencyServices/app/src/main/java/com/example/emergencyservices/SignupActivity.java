...
//                openMainActivity();
    ...
    public void Signup(){
        ...
        String bloodgrp_local = bloodgrp.getSelectedItem().toString();
        ...
        if(phno_local.length()!=10){
            ...
            sc = new SignupConnect(username_local,password_local,phno_local,bloodgrp_local);
            sc.execute();
        }
    }

    public class SignupConnect extends AsyncTask<String,String,String> {
        private final String name_local,password_local,phno_local,bloodgrp_local;
        SignupConnect(String n,String p,String ph,String b){
            name_local = n;
            password_local = p;
            phno_local = ph;
            bloodgrp_local = b;
        ...
        protected String doInBackground(String... params){
            ...
            try{
                ...
                jsonObject.put("BloodGroup",bloodgrp_local);
                String serverURL="http://"+ip+":8080/EmergencyServicesBackend/webapi/resource/signup";
                ...
                line = total.toString();
                line = line.trim();
                Log.d("SignupActivity","Data from the Server: " + line);
                res = line;
                return res;
            }
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Log.d("SignupActivity", "User in Authentic, Display the MainActivity");
            ...
            {
                Log.e("SignupActivity", "Name or Password cannot be empty");
                Toast.makeText(SignupActivity.this,"Name or Password cannot be empty",Toast.LENGTH_LONG).show();
            }
            else if(s.equals("This name already exists! Try a new name :)"))
            {
                Log.e("SignupActivity", "This name already exixts! Try a new name :)" );
                Toast.makeText(SignupActivity.this,"This name already exixts! Try a new name :)",Toast.LENGTH_LONG).show();
            }
            else
            {
